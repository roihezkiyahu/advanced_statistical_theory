...
\\
\textrm{thus the joint distribution of } (X_1,X_2,X_3) \textrm{ belongs to the exponential family with the minimal and complete sufficent statistic } (T_1(X),T_2(X))
$$
